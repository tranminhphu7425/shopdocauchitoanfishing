...
const ShopInfo = ({ totalProducts = 47 }: { totalProducts?: number }) => {
  const shopData = {
    ...
    avatar:
      "https://down-bs-vn.img.susercontent.com/vn-11134216-81ztc-mnh0zou8j09466_tn.webp",
    cover_image:
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-start">
          <div className="flex-1">
            ...
            <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed">
              ...
              - điểm đến hàng đầu cho những tâm hồn đam mê nghệ thuật câu cá.
              Chúng tôi tự hào là đơn vị chuyên cung cấp các dòng sản phẩm đồ
              câu chính hãng, từ những chiếc cần câu lure nhạy bén, máy câu
              kháng mặn bền bỉ cho đến các loại mồi thủ công tinh xảo. Với mong
              muốn đồng hành cùng các cần thủ trong mọi chuyến đi, chúng tôi cam
              kết mang đến những trang thiết bị chất lượng nhất, được tuyển chọn
              kỹ lưỡng từ các thương hiệu uy tín.
            </p>
          </div>
