    ...
    <div className="mx-auto max-w-4xl px-4 py-12 md:py-24">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
          Hãy liên hệ với <strong className="text-neutral-900 dark:text-white">Chí Toàn Fishing Shop</strong> qua các kênh dưới đây để được tư vấn, hỗ trợ mua hàng và giải đáp thắc mắc nhanh nhất.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
        ...
        >
          ...
          <h3 className="text-xl font-bold text-neutral-900 dark:text-white mb-2">Điện thoại / Zalo</h3>
          <p className="text-orange-600 font-bold text-2xl tracking-wide">034 866 7831</p>
        </a>
        ...
        >
          ...
          <h3 className="text-xl font-bold text-neutral-900 dark:text-white mb-2">Facebook Messenger</h3>
        ...
        >
          ...
          <h3 className="text-xl font-bold text-neutral-900 dark:text-white mb-2">Gian Hàng Shopee</h3>
          <p className="text-orange-600 font-bold text-lg">Chí Toàn Fishing Shop</p>
        </a>
        ...
        >
          <div className="w-20 h-20 bg-neutral-100 dark:bg-neutral-800 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-neutral-900 dark:text-white">
              <path strokeLinecap="round" d="M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9A2.25 2.25 0 002.25 9.75v9a2.25 2.25 0 002.25 2.25z" />
            </svg>
          </div>
          <h3 className="text-xl font-bold text-neutral-900 dark:text-white mb-2">Kênh TikTok</h3>
          <p className="text-neutral-900 dark:text-white font-bold text-lg">@chi_toan_fishing_</p>
        </a>
      </div>
      
      <div className="mt-16 text-center animate-in fade-in slide-in-from-bottom-10 duration-700 delay-300">
        <Link to="/" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-neutral-900 dark:bg-white text-white dark:text-black font-bold rounded-full hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-colors shadow-lg hover:shadow-xl">
